...
export function ProvideLiquidity() {
  ...
  if (!isWalletConnected) {
    return (
      <div className="max-w-lg mx-auto p-6 bg-white rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Provide Liquidity</h2>
  ...
  if (routersError) {
    return (
      <div className="max-w-lg mx-auto p-6 bg-white rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Provide Liquidity</h2>
        <p className="text-red-600">Error fetching routers: {String(routersError)}</p>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-lg mx-auto p-6 bg-white rounded-xl shadow-lg">
        ...
        <p className="text-gray-700">
          No suitable router found (looking for a router with v2.2 and pool creation enabled).
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white rounded-xl shadow-lg">
      ...
      <div className="mt-4 text-sm text-gray-500">
        ...
        <p>Version: v{matchedRouter.majorVersion}.{matchedRouter.minorVersion}</p>
      </div>
    </div>
  );
} 